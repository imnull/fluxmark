...
export type ComponentMap = {
  ...
  blockquote: Component<BlockquoteProps>;
  image: Component<ImageProps>;
  thematicBreak: Component<ThematicBreakProps>;
  incomplete: Component<IncompleteProps>;
};
...
export interface FragmentSlots {
  default?: (props: { fragment: Fragment }) => VNode[];
}
